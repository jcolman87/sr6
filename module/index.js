...
Hooks.once("init", async function () {
    ...
    CONFIG.Item.systemDataModels.SIN = DataModels.SIN;
    CONFIG.Item.systemDataModels.Lifestyle = DataModels.Lifestyle;
    CONFIG.Item.systemDataModels.Contact = DataModels.Contact;
    registerSheets();
