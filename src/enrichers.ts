...
export function register(): void {
	CONFIG.TextEditor.enrichers = [
		...
		/**
		 * Enricher to easily add SR6 dice into the document.
		 *
		 ...
		 */
		{
			...
			enricher: async (match, _) => {
				...
				container.className = 'font-sr6-symbols';
		...
		/**
		 * Enricher to easily add SR6 symbols into the document.
		 */
		{
		 ...
		 */
		{
			...
			enricher: async (match, _) => {
				...
				container.innerHTML =
					...
					game.i18n.format('SR6.Enrichers.Difficulty', {
