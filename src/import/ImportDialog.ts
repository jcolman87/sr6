...
export class ImportDialog extends SR6Dialog {
	...
	activateListeners(html: JQuery): void {
		...
		html.find(".go").click(async (event: JQuery.ClickEvent) => {
...
export function addImportButton(app: ItemDirectory, html: JQuery, data: any) {
		let button = $(
			"<button class='import-dialog'><i class='fas fa-edit'></i></i>Import</button>"
		);
